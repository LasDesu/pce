...
static
void wav_setup_iir (wav_save_t *wav, wav_iir2_t **iir, unsigned *cnt)
{
	...
	*iir = wav->iir;
	...
	wav_iir_butterworth (*iir, *cnt, wav->par->lowpass, wav->img->clock);
}
